var rid='19157c0d73ex6c374754x4j422d';
...
$(`<style>
.nosel.d-flex.room.r19157c0d73ex6c374754x4j422d .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r19157c0d73ex6c374754x4j422d .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel.d-flex.r19157c0d73ex6c374754x4j422d.bord {border-inline: 0px solid #4c121e !important;}
.nosel.d-flex.room.r19157c0d73ex6c374754x4j422d .dots.mini.u-msg {
    text-align: center;
...
.nosel.d-flex.room.r19157c0d73ex6c374754x4j422d {
    background-image: url(https://up6.cc/2024/08/172461253253281.gif);
...
.nosel.d-flex.room.r19157c0d73ex6c374754x4j422d.u-topic.dots {
  text-transform: uppercase;
  -webkit-text-fill-color: #e84d58;
  animation: textclip 2s linear infinite;
  display: inline-block;
  font-size: 22px !important;
  background-image: url(https://up6.cc/2024/08/172462278575642.png);
  -webkit-background-clip: text;
  color: transparent !important;
...
#upro.l7dah1 .modal-header.label-primary {
  ...
  background-image: url(https://up6.cc/2024/08/172462227724841.png);
  background-size: cover;
}
...
#d2.l7dah1 .label-primary{background-color:#b77c7c!important}#d2.l7dah1 .bg{background-color:#b77c7c!important}#d2.l7dah1 .uzr.d-flex.mm.hmsg{border-radius: 10px 0 10px;background-color: #f3f3f3!important;}#dpnl.l7dah1{background-size: 100%;background-image: url(https://up6.cc/2024/08/172462227724841.png);background-color: #efefef;  }#dpnl.l7dah1 .light{background-color:#878686!important;background-image:linear-gradient(ffdf49,#ffffff 0%,#ebeaea 29%,#fbdcdc 67%,#f7f7f7 100%);}#d0b500.l7dah1 .nosel.fl.bg.{background-color:#d9d0d5!important;  }#users.l7dah1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#ededed 0,#f3f3f3 29%,#ebebeb 67%,#ff0018 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
#users.l7dah1 .mini.u-msg{text-align:center;}#dpnl.l7dah1.bg{background-image:linear-gradient(225deg,#e9adcc 0%,#d5c4c4 29%,#f0dce6 67%,#b77c9a 100%) */}#rooms.l7dah1 .corner.fa.fa-user.label.uc.fa-microphone.label-danger{border-radius: 10px 0 10px!important}
...
#d0.l7dah1 .label-primary {
    ...
    border-radius: 10px 0 10px!important;
    background-image: url(https://up6.cc/2024/08/172462227726582.png);
    color: #ffffff;
    background-size: 100%;
}
...
#upro.l7dah1 .light.fl.pro.break {
    ...
    background-image: url(https://up6.cc/2024/08/172462246386292.png);
    background-size: 100%;
}
#mic.l7dah1 #muteall {
    border-radius: 10px 0 10px;
...
#rooms.l7dah1{background-color:#e1e0e1!important;background-image:linear-gradient(225deg,#c6c4c5 0%,#efeeef 29%,#f4f4f4 67%,#f9dbea 100%)}#settings.l7dah1{background-color:#ececec!important;background-image:linear-gradient(225deg,#e3c4d3 0%,#eceaeb 29%,#f4f4f4 67%,#f9dbea 100%)}#d2bc.l7dah1{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#e3c4d3 0%,#fdedf5 29%,#f4f4f4 67%,#f9dbea 100%)}
input.l7dah1 {
  border-radius:  10px 0 10px!important;
  border: 1px solid #ecdce4;
}
...
setInterval(function () {
    if (myroom == '19157c0d73ex6c374754x4j422d') {
        if (l7dah == false) {
            l7dah = true;
